...
import com.example.demo.deliveryorder.GenerateDeliveryOrder
...
import com.example.demo.deliveryorder.repositories.IDeliveryChannelRepository
import com.example.demo.deliveryorder.repositories.IDeliveryOrderRepository
import com.example.demo.deliveryorder.repositories.IRawDeliveryDataRepository
...
class DeliveryOrderCommandHandler(
    ...
    val airWaybillService: AirWaybillService,
) {
    ...
    private fun generateDeliveryOrders(
        ...
        DeliveryOrder(
            ...
            airWaybillNumber = airWaybillService.generateUniqueAirWaybillNumber(),
            issuedDate = date,
